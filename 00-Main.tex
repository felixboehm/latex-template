...
\usepackage{csquotes} % Load csquotes before biblatex
...
\usepackage[hidelinks,hypertexnames=false]{hyperref} %https://tex.stackexchange.com/questions/823/remove-ugly-borders-around-clickable-cross-references-and-hyperlinks
\usepackage{bookmark}
